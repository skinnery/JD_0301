...
| `JD_USER_AGENT`         |   京东   | 非必须   | 自定义此库里京东系列脚本的UserAgent，不懂不知不会UserAgent的请不要随意填写内容。具体获取参考此[issue],如需使用此功能建议填写京东APP的UA(https://github.com/lxk0301/jd_scripts/issues/127) |
